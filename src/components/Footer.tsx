	...
	return (
		<div class="flex flex-col items-center justify-center gap-8 py-8 text-sm">
			<div class="flex flex-col items-center gap-2">
				...
				<img src={logo} class="h-auto w-42 opacity-70" />
			</div>
			<div class="flex flex-row gap-4">
				<a href=""><img src={si1} class="h-6 w-6" /></a>
				<a href=""><img src={si2} class="h-6 w-6" /></a>
				<a href=""><img src={si3} class="h-6 w-6" /></a>
				<a href=""><img src={si4} class="h-6 w-6" /></a>
				<a href=""><img src={si5} class="h-6 w-6" /></a>
			</div>
